...
document.addEventListener('DOMContentLoaded', function(){
    table_configuration('#'+table_name,'Tickets vencidos');
    table = $('#'+table_name).DataTable({
          "ajax":{
            "url": " "+base_url+"/tickets/list_expired?ticket="+$('#filter_tickets').val()+"&affair="+$('#listfilAffairs').val()+"&state="+$('#listStates').val(),
            "dataSrc": ""
          },
          "deferRender": true,
          "idDataTables": "1",
...
window.addEventListener('load', function(){
    ...
    $('#listPriority,#listStates,#filter_tickets').select2({
      minimumResultsForSearch: -1
    });
},false);
function filter_tickets(){
  table.ajax.url(base_url+"/tickets/list_expired?ticket="+$('#filter_tickets').val()+"&affair="+$('#listfilAffairs').val()+"&state="+$('#listStates').val()).load();
}
