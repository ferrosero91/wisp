...
document.addEventListener('DOMContentLoaded', function(){
  ...
  table_ticket = $('#'+table_name_ticket).DataTable({
        ...
        "columns": [
            ...
            {"data":"incident"},
            {"data": "attention_date","render": function(data,type,full,meta){
                return moment(data).format('DD/MM/YYYY H:mm');
            }},
            {"data":"opening_date","render": function(data,type,full,meta){
                var opening_date = '';
            ...
            {"data":"closing_date","render": function(data,type,full,meta){
                var closing_date = '';
                if(data == '0000-00-00 00:00:00'){
            ...
            {"data":"priority","render": function(data,type,full,meta){
                var priority = '';
                if(data == 1){
                  priority = '<span style="color:#00acac;border: 1px solid #00acac;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">BAJA</span>';
                }
                if(data == 2){
                  priority = '<span style="color:#4da1ff;border: 1px solid #4da1ff;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">MEDIA</span>';
                }
                if(data == 3){
                  priority = '<span style="color:#F59C1A;border: 1px solid #F59C1A;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">ALTA</span>';
                }
                if(data == 4){
                  priority = '<span style="color:#ff5959;border: 1px solid #ff5959;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">URGENTE</span>';
                }
                return priority;
        ...
        initComplete: function(oSettings, json){
          $('#'+table_name_ticket+'_wrapper div.container-options').append($('#'+table_name_ticket+'-btns-tools').contents());
        }
  });
  ...
  table_internet = $('#'+table_name_inter).DataTable({
        ...
        initComplete: function(oSettings, json){
          $('#'+table_name_inter+'_wrapper div.container-options').append($('#'+table_name_inter+'-btns-tools').contents());
        }
  });
  ...
  table_personalized = $('#'+table_name_person).DataTable({
        ...
        initComplete: function(oSettings, json){
          $('#'+table_name_person+'_wrapper div.container-options').append($('#'+table_name_person+'-btns-tools').contents());
        }
  });
  ...
  table_transactions = $('#'+table_name_trans).DataTable({
        ...
        "columns": [
            {"data":"internal_code",'className':'text-center'},
            {"data":"invoice","render": function(data,type,full,meta){
                return '<a href="javascript:;" onclick="view_bill(\''+full.encrypt_bill+'\')">'+data+'</a>';
            },'className':'text-center'},
  ...
  table_bills = $('#'+table_name_bills).DataTable({
        ...
        "columns": [
            ...
            {"data":"type","render": function(data,type,full,meta){
              var type_bill = '';
              if(data == 1){
                type_bill = '<span style="color:#4da1ff;border: 1px solid #4da1ff;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">LIBRE</span>';
              }
              if(data == 2){
                type_bill = '<span style="color:#F59C1A;border: 1px solid #F59C1A;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">SERVICIOS</span>';
              }
              return type_bill;
            }},
            {"data": "payment_date"},
            {"data": "waytopay"},
            {"data":"sales_method","visible":false,"render": function(data,type,full,meta){
                  var sales_method = '';
                  if(data == 1){
        ...
        initComplete: function(oSettings, json){
          $('#'+table_name_bills+'_wrapper div.container-options').append($('#'+table_name_bills+'-btns-tools').contents());
        }
  });
                  ...
                  if(request.readyState == 4 && request.status == 200){
                      ...
                      if(objData.status == "success"){
                          ...
                          if(objData.modal){
                            ...
                            document.querySelector('#text-title-message').innerHTML = "Ticket Nº "+objData.code;
                            document.querySelector('#message_text_country').innerHTML = "+"+objData.country_code;
                            document.querySelector('#message_country_code').value = objData.country_code;
                            document.querySelector('#message_number_client').value = objData.mobile;
                            document.querySelector('#idpdfticket').value = objData.encrypt;
  ...
  if(document.querySelector("#transactions_internet")){
      var transactions_internet = document.querySelector("#transactions_internet");
  ...
  if(document.querySelector("#transactions_personalized")){
      var transactions_personalized = document.querySelector("#transactions_personalized");
                  ...
                  if(objData.status == "success"){
                      ...
                      if(objData.modal){
                        $("#modal-free").on("hidden.bs.modal", function (){
                          ...
                          alert_msg("success",objData.msg);
                          document.querySelector('#idbillvoucher').value = objData.idbill;
                          document.querySelector('#text-title-voucher').innerHTML = objData.voucher+" Nº "+objData.correlative;
                          document.querySelector('#text_country').innerHTML = "+"+objData.country;
                          document.querySelector('#country_code').value = objData.country;
                          document.querySelector('#bill_number_client').value = objData.mobile;
                          var url = base_url+"/invoice/document/"+objData.idbill;
                          if(objData.remaining_amount == 0){
                              if(objData.type == 1){
                              var msg = `Hola, se registro ${objData.symbol+objData.amount_paid} al ${objData.voucher.toLowerCase()} número ${objData.serie} del cliente ${objData.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.business_name}`;
                              }else{
                              var dateAr = objData.billed_month.split('-');
                              var month = dateAr[1];
                              var year = dateAr[0];
                              var msg = `Hola, se registro ${objData.symbol+objData.amount_paid} al ${objData.voucher.toLowerCase()} número ${objData.serie} de ${month_letters(month).toUpperCase()} del cliente ${objData.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.business_name}`;
                              }
                          }else{
                            if(objData.type == 1){
                              if(objData.amount_paid == 0){
                              var msg = `Hola, esta pendiente el pago de ${objData.symbol+objData.remaining_amount} del ${objData.voucher.toLowerCase()} número ${objData.serie} del cliente ${objData.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.business_name}`;
                              }else{
                              var msg = `Hola, se registro ${objData.symbol+objData.amount_paid} al ${objData.voucher.toLowerCase()} número ${objData.serie}, quedando un saldo pendiente de ${objData.symbol+objData.remaining_amount} del cliente ${objData.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.business_name}`;
                              }
                            }else{
                                var dateAr = objData.billed_month.split('-');
                                var month = dateAr[1];
                                var year = dateAr[0];
                                if(objData.amount_paid == 0){
                                var msg = `Hola, esta pendiente el pago de ${objData.symbol+objData.remaining_amount} del ${objData.voucher.toLowerCase()} número ${objData.serie} de ${month_letters(month).toUpperCase()} del cliente ${objData.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.business_name}`;
                                }else{
                                var msg = `Hola, se registro ${objData.symbol+objData.amount_paid} al ${objData.voucher.toLowerCase()} número ${objData.serie} de ${month_letters(month).toUpperCase()}, quedando un saldo pendiente de ${objData.symbol+objData.remaining_amount} del cliente ${objData.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.data.business.business_name}`;
                                }
                            }
                          }
  ...
  if(document.querySelector("#transactions_facser")){
      ...
      transactions_facser.onsubmit = function(e){
          ...
          if(filas.children.length === 0) {
              alert_msg("error","No hay servicios, agregué uno o mas para poder realizar la facturación.");
               return false;
          }
          if(state_current !== ""){
            if(state == 1 || state == 4){
                alert_msg("warning","Para editar la factura esta tiene que estar en estado pendiente o vencido.");
                return false;
            }
          }
          showLoading('Guardando factura...');
  ...
  if(document.querySelector("#transactions_payments")){
    var transactions_payments = document.querySelector("#transactions_payments");
  ...
  if(document.querySelector("#transactions_finalize")){
    var transactions_finalize = document.querySelector("#transactions_finalize");
...
window.addEventListener('load', function(){
    ...
    $('#listTypePay').select2();
    $('#date_time,#attention_date,#scheduled_date').datetimepicker({locale:'es'});
    $('#image-user').initial({
        height:45,
        width:45,
        charCount:2,
    ...
    $('#freeissue,#freeexpiration,#servissue').val(moment().format('DD/MM/YYYY'));
...
function location_error(error){
    alert_msg('warning','No se pudo obtener su ubicaciòn actual ('+error.message+')');
    $('.btn-coordinates').html('<i class="fas fa-location-arrow"></i>');
    $('[data-toggle="tooltip"]').tooltip('hide');
}
function current_location(){
  ...
  navigator.geolocation.getCurrentPosition(get_location,location_error,options);
}
function open_map(){
  ...
  request.onreadystatechange = function(){
      if(request.readyState == 4 && request.status == 200){
          ...
          if(objData.status == "success"){
                ...
                document.querySelector('#client_free').value = objData.data.names+" "+objData.data.surnames;
            ...
            if(objData.status == "success"){
                if(objData.data.service){
                  if(objData.data.invoice.status == 4){
                    alert_msg("info","El servicio esta cancelado.");
                  }else if(objData.data.invoice.status == 5){
                    alert_msg("info","El servicio es gratis.");
                  }else{
                    document.querySelector("#cont-iss-serv").setAttribute("class","col-md-3 form-group");
                    document.querySelector("#cont-exp-serv").setAttribute("class","col-md-3 form-group");
                    document.querySelector("#cont-state-serv").style.display = "none";
                    localStorage.setItem("state_current", "");
                    document.querySelector('#idcliser').value = objData.data.invoice.encrypt_client;
                    document.querySelector('#client_serv').value = objData.data.invoice.client;
                    document.querySelector('#servexpiration').value = objData.data.invoice.expiration;
                    document.querySelector('#billed_month').value = objData.data.invoice.billed_month;
                    document.querySelector('#discountserv').value = objData.data.invoice.discount;
                    $('#servissue').val(moment().format('DD/MM/YYYY'));
                    var template = '';
                    objData.data.detail.forEach((detail) => {
                        template += `
                            <tr class="item-row2">
                            <td><input type="hidden" name="idproducto[]" value="${detail.id}"><input type="hidden" name="tipo[]" value="2"><input class="form-control text-uppercase" placeholder="Descripción" name="descripcion[]" value="${detail.service}"></td>
                            <td><input type="text" class="form-control costos" placeholder="100" name="costo[]" value="${roundNumber(detail.price,2)}"></td>
                            <td><input type="text" class="form-control unidads" placeholder="1" min="1" name="unidad[]" value="1" readonly></td>
                            <td><input type="text" class="form-control totals" placeholder="100" name="totales[]" value="${roundNumber(detail.price,2)}"></td>
                            <td></td>
                            </tr>
                        `;
                    });
                    $('#table-plans tbody').html(template);
                    calculateTotals('.item-row2','.costos','.unidads','.totals','#subtotalserv','#discountserv','#totalserv','#text-sub','#text-dis','#text-total');
                    voucher_service();
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status == "success"){
                var transactions_payments = document.querySelector("#transactions_payments");
                transactions_payments.reset();
                document.querySelector('#text-payment').innerHTML = "Agregar Pago "+objData.data.voucher+" Nº "+objData.data.invoice;
                ...
                document.querySelector("#idbillpayment").value = objData.data.encrypt_bill;
                document.querySelector("#idbillclient").value = objData.data.encrypt_client;
                document.querySelector("#total_payment").value = objData.data.remaining_amount;
                $('#date_time').val(moment().format('DD/MM/YYYY H:mm'));
                $("#total_payment").trigger("touchspin.updatesettings", {max: objData.data.remaining_amount});
...
function add_product(id,product,code,price,stock){
    ...
    if (id !== ""){
        if(stock >= 1){
            ...
            var items='<tr class="item-row">'+
            '<td class="text-center" style="line-height:30px">'+code+'</td>'+
            '<td><input type="hidden" name="idproducto[]" value="'+id+'"><input type="hidden" name="tipo[]" value="1"><input class="form-control text-uppercase" placeholder="Descripción" name="descripcion[]" value="'+product+'"></td>'+
            '<td><input type="text" class="form-control costo" placeholder="100" name="costo[]" value="'+roundNumber(price,2)+'"></td>'+
            '<td><input type="number" class="form-control unidad" placeholder="1" min="1" max="'+stock+'" onchange="validate_stock('+id+','+stock+');" id="quantity_temp-'+id+'" name="unidad[]" value="'+quantity+'"></td>'+
            '<td><input type="text" class="form-control total" placeholder="100"  name="totales[]" value="'+roundNumber(subtotal,2)+'"></td>'+
            ...
            if(existence == false){
                ...
                calculateTotals('.item-row','.costo','.unidad','.total','#subtotalfree','#discountfree','#totalfree','#text-sub-f','#text-dis-f','#text-total-f');
                document.querySelector(".search-input").classList.remove("active");
                document.querySelector('#box-search').innerHTML = "";
                document.querySelector('#search_products').value = "";
...
function addItem(option){
  if(option == "libre"){
    items = `
        ...
        <td><input type="text" class="form-control costo" placeholder="100" name="costo[]" value="${roundNumber(0,2)}"></td>
        <td><input type="number" class="form-control unidad" placeholder="1" min="1" name="unidad[]" value="1"></td>
        <td><input type="text" class="form-control total" placeholder="100"  name="totales[]" value="${roundNumber(0,2)}"></td>
        <td class="text-center"><button type="button" class="deletefile btn btn-white"><i class="far fa-trash-alt"></i></button></td>
        </tr>
    `;
    $('#table-free tbody').append(items);
    ...
    items = `
        <tr class="item-row2">
        <td><input type="hidden" name="idproducto[]" value="0"><input type="hidden" name="tipo[]" value="1"><input class="form-control text-uppercase" placeholder="Descripción" name="descripcion[]" value=""></td>
        <td><input type="text" class="form-control costos" placeholder="100" name="costo[]" value="${roundNumber(0,2)}"></td>
        <td><input type="text" class="form-control unidads" placeholder="1" min="1" name="unidad[]" value="1"></td>
        <td><input type="text" class="form-control totals" placeholder="100" name="totales[]" value="${roundNumber(0,2)}"></td>
...
function modify_quantity(id,rowid,stock){
    var previous_amount = $('#table-free tr:nth-child('+rowid+')').find('td:eq(3)').find(".unidad").val();
    if(stock > previous_amount){
        var new_quantity = parseInt(previous_amount) + 1;
        $('#table-free tr:nth-child('+rowid+')').find('td:eq(3)').find(".unidad").val(new_quantity);
        calculateTotals('.item-row','.costo','.unidad','.total','#subtotalfree','#discountfree','#totalfree','#text-sub-f','#text-dis-f','#text-total-f');
    }
    if(stock <= previous_amount){
...
function calculateTotals(itemRow,price,qtycl,totalcl,subTotal,discount,totalNeto,textsub,textdis,textto){
...
function view_bill(idbill){
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            var objData = JSON.parse(request.responseText);
            if(objData.status == "success"){
                document.querySelector('#text-view').innerHTML = "Detalle de factura ("+objData.data.bill.voucher+" Nº "+objData.data.bill.correlative+")";
                document.querySelector('#view-client').innerHTML = objData.data.bill.names+" "+objData.data.bill.surnames;
                document.querySelector('#view-typedoc').innerHTML = objData.data.bill.type_doc;
                document.querySelector('#view-doc').innerHTML = objData.data.bill.document;
                document.querySelector('#view-address').innerHTML = objData.data.bill.address;
                document.querySelector('#view-mobile').innerHTML = objData.data.bill.mobile;
                document.querySelector('#view-issue').innerHTML = "Emisión "+moment(objData.data.bill.date_issue).format('DD/MM/YYYY');
                document.querySelector('#view-expiration').innerHTML = "Vencimiento "+moment(objData.data.bill.expiration_date).format('DD/MM/YYYY');
                document.querySelector('#view-sub').innerHTML = currency_symbol+objData.data.bill.subtotal;
                document.querySelector('#view-dis').innerHTML = currency_symbol+objData.data.bill.discount;
                document.querySelector('#view-total').innerHTML = currency_symbol+objData.data.bill.total;
                document.querySelector('#view-observation').innerHTML = objData.data.bill.observation;
                ...
                if(objData.data.payments.length === 0){
                  ...
                  objData.data.payments.forEach((payment) => {
                      template_trans += `
                          <tr>
                              <td class="text-center">${payment.internal_code}</td>
                              <td class="text-center">${moment(payment.payment_date).format('DD/MM/YYYY H:mm')}</td>
                              <td class="text-center">${currency_symbol}${payment.amount_paid}</td>
...
$('#btn-ticket').on('click',function(){
    var idbill = document.querySelector('#idbillvoucher').value;
    window.open(base_url+'/customers/bill_voucher/'+idbill+'/ticket', '_blank');
});
  ...
  request.onreadystatechange = function(){
      if(request.readyState == 4 && request.status == 200){
          ...
          if(objData.status == "success"){
              ...
              document.querySelector('#text-button-facser').innerHTML ="Guardar Cambios";
              document.querySelector('#idfacser').value = objData.data.bill.encrypt_bill;
              document.querySelector('#idcliser').value = objData.data.bill.encrypt_client;
              document.querySelector('#client_serv').value = objData.data.bill.names+" "+objData.data.bill.surnames;
              document.querySelector("#client_serv").readOnly = true;
              document.querySelector('#servissue').value = moment(objData.data.bill.date_issue).format('DD/MM/YYYY');
              document.querySelector('#servexpiration').value = moment(objData.data.bill.expiration_date).format('DD/MM/YYYY');
              ...
              document.querySelector('#vouchersserv').value = objData.data.bill.encrypt_voucher;
              $('#vouchersserv').select2();
              serie_serv(objData.data.bill.encrypt_voucher);
              document.querySelector('#serieserv').value = objData.data.bill.encrypt_serie;
              document.querySelector('#observ').value = objData.data.bill.observation;
              document.querySelector('#subtotalserv').value = objData.data.bill.subtotal;
              document.querySelector('#discountserv').value = objData.data.bill.discount;
              document.querySelector('#totalserv').value = objData.data.bill.total;
              document.querySelector('#text-sub').innerHTML = objData.data.bill.subtotal;
              document.querySelector('#text-dis').innerHTML = objData.data.bill.discount;
              document.querySelector('#text-total').innerHTML = objData.data.bill.total;
              var template = '';
              if(objData.data.detail.length === 0){
                template+=`
                <tr>
                ...
                `;
                  ...
                  objData.data.detail.forEach((detail) => {
                      if(detail.type == 1){
                        template += `
                            <tr class="item-row2">
                              <td><input type="hidden" name="idproducto[]" value="${detail.serproid}"><input type="hidden" name="tipo[]" value="${detail.type}"><input class="form-control text-uppercase" placeholder="Descripción" name="descripcion[]" value="${detail.description}"></td>
                              <td><input type="text" class="form-control costos" placeholder="100" name="costo[]" value="${roundNumber(detail.price,2)}"></td>
                              <td><input type="text" class="form-control unidads" placeholder="1" min="1" name="unidad[]" value="${detail.quantity}" readonly></td>
                              <td><input type="text" class="form-control totals" placeholder="100" name="totales[]" value="${roundNumber(detail.total,2)}"></td>
                              <td class="text-center"><button type="button" class="deletefile2 btn btn-white"><i class="far fa-trash-alt"></i></button></td>
                            </tr>
                        `;
                      }else{
              ...
              $('#table-plans tbody').html(template);
              document.querySelector("#cont-iss-serv").setAttribute("class","col-md-2 form-group");
              document.querySelector("#cont-exp-serv").setAttribute("class","col-md-2 form-group");
...
function print_options(idbill){
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            var objData = JSON.parse(request.responseText);
            if(objData.status){
                document.querySelector('#text-title-voucher').innerHTML = objData.data.bill.voucher+" Nº "+objData.data.bill.correlative;
                document.querySelector('#idbillvoucher').value = objData.data.bill.encrypt_bill;
                document.querySelector('#text_country').innerHTML = "+"+objData.data.business.country_code;
                document.querySelector('#country_code').value = objData.data.business.country_code;
                document.querySelector('#bill_number_client').value = objData.data.bill.mobile;
                var url = base_url+"/invoice/document/"+objData.data.bill.encrypt_bill;
                if(objData.data.bill.remaining_amount == 0){
                    if(objData.data.bill.type == 1){
                      var msg = `Hola, se registro ${objData.data.business.symbol+objData.data.bill.amount_paid} al ${objData.data.bill.voucher.toLowerCase()} número ${objData.data.bill.serie} del cliente ${objData.data.bill.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.data.business.business_name}`;
                    }else{
                        var dateAr = objData.data.bill.billed_month.split('-');
                        var month = dateAr[1];
                        var year = dateAr[0];
                        var msg = `Hola, se registro ${objData.data.business.symbol+objData.data.bill.amount_paid} al ${objData.data.bill.voucher.toLowerCase()} número ${objData.data.bill.serie} de ${month_letters(month).toUpperCase()} del cliente ${objData.data.bill.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.data.business.business_name}`;
                    }
                }else{
                  if(objData.data.bill.type == 1){
                    if(objData.data.bill.amount_paid == 0){
                      var msg = `Hola, esta pendiente el pago de ${objData.data.business.symbol+objData.data.bill.remaining_amount} del ${objData.data.bill.voucher.toLowerCase()} número ${objData.data.bill.serie} del cliente ${objData.data.bill.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.data.business.business_name}`;
                    }else{
                      var msg = `Hola, se registro ${objData.data.business.symbol+objData.data.bill.amount_paid} al ${objData.data.bill.voucher.toLowerCase()} número ${objData.data.bill.serie}, quedando un saldo pendiente de ${objData.data.business.symbol+objData.data.bill.remaining_amount} del cliente ${objData.data.bill.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.data.business.business_name}`;
                    }
                  }else{
                      var dateAr = objData.data.bill.billed_month.split('-');
                      var month = dateAr[1];
                      var year = dateAr[0];
                      if(objData.data.bill.amount_paid == 0){
                      var msg = `Hola, esta pendiente el pago de ${objData.data.business.symbol+objData.data.bill.remaining_amount} del ${objData.data.bill.voucher.toLowerCase()} número ${objData.data.bill.serie} de ${month_letters(month).toUpperCase()} del cliente ${objData.data.bill.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.data.business.business_name}`;
                      }else{
                      var msg = `Hola, se registro ${objData.data.business.symbol+objData.data.bill.amount_paid} al ${objData.data.bill.voucher.toLowerCase()} número ${objData.data.bill.serie} de ${month_letters(month).toUpperCase()}, quedando un saldo pendiente de ${objData.data.business.symbol+objData.data.bill.remaining_amount} del cliente ${objData.data.bill.client}. Puede revisarlo en el siguiente enlace: ${url}. Muchas gracias por su pago, Atte. ${objData.data.business.business_name}`;
                      }
                  }
                }
                document.querySelector('#msg').value = msg;
...
function voucher_free(){
    if(document.querySelector('#vouchersfree')){
        ...
        request.onreadystatechange = function(){
            if(request.readyState == 4 && request.status == 200){
                document.querySelector('#vouchersfree').innerHTML = request.responseText;
...
function voucher_service(){
    if(document.querySelector('#vouchersserv')){
        ...
        request.onreadystatechange = function(){
            if(request.readyState == 4 && request.status == 200){
                document.querySelector('#vouchersserv').innerHTML = request.responseText;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status == "success"){
                ...
                document.querySelector('#text-payment').innerHTML = "Agregar Pago "+objData.data.voucher+" Nº "+objData.data.invoice;
                document.querySelector('#client_name').innerHTML = objData.data.client;
                document.querySelector('#text-alert').innerHTML = '<small class="text-success text-uppercase">El total pagado no es editable</small>';
                document.querySelector("#idpayment").value = objData.data.encrypt_id;
                document.querySelector("#idbillpayment").value = objData.data.encrypt_bill;
                document.querySelector("#date_time").value = objData.data.date;
                document.querySelector("#idbillclient").value = objData.data.encrypt_client;
                document.querySelector("#total_payment").value = objData.data.amount_paid;
                $("#total_payment").trigger("touchspin.updatesettings", {max: objData.data.amount_paid});
...
$('#btn-msg').on('click',function(){
    let cell = document.querySelector('#bill_number_client').value;
    if(cell !== ""){
        let country = document.querySelector('#country_code').value;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status == "success"){
                ...
                document.querySelector("#idticketclient").value = objData.data.encrypt_client;
                document.querySelector('#client_ticket').value = objData.data.names+" "+objData.data.surnames;
                document.querySelector("#listTechnical").value = objData.data.encrypt_technical;
                $('#listTechnical').select2();
                document.querySelector("#listAffairs").value = objData.data.encrypt_incident;
                $('#listAffairs').select2();
                document.querySelector("#attention_date").value = moment(objData.data.attention_date).format('DD/MM/YYYY H:mm');
...
function finalize_ticket(idticket){
  ...
  request.onreadystatechange = function(){
      if(request.readyState == 4 && request.status == 200){
          ...
          if(objData.status == "success"){
            $('[data-toggle="tooltip"]').tooltip('hide');
            document.querySelector('#text-finalize').innerHTML = "Finalizar Ticket #"+objData.data.code;
            document.querySelector('#idticketfinalize').value = objData.data.encrypt_ticket;
...
function view_ticket(idticket){
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            var objData = JSON.parse(request.responseText);
            if(objData.status == "success"){
              document.querySelector('#text-view-ticket').innerHTML = "Ticket Nº "+objData.data.ticket.code;
               document.querySelector('#view-client-ticket').innerHTML = objData.data.ticket.client;
               document.querySelector('#view-celdoc-ticket').innerHTML = "<b>"+objData.data.ticket.type_doc+":</b> "+objData.data.ticket.document+" <b>CEL:</b> "+objData.data.ticket.mobile;
               document.querySelector('#view-address-ticket').innerHTML = objData.data.ticket.address;
               document.querySelector("#view-image-ticket").src = generateAvatar(objData.data.ticket.client);
               document.querySelector('#view-created-ticket').innerHTML = "Creado "+moment(objData.data.ticket.registration_date).format('DD/MM/YYYY H:mm');
               document.querySelector('#view-visit-ticket').innerHTML = "Programado "+moment(objData.data.ticket.attention_date).format('DD/MM/YYYY H:mm');
              var star = "";
              if(objData.data.ticket.priority == 1){
                document.querySelector('#view-priority-ticket').innerHTML = '<span style="color:#00acac;border: 1px solid #00acac;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">BAJA</span>';
                document.querySelector('#view-star').innerHTML ='<i class="fas fa-star"></i>';
              }else if(objData.data.ticket.priority == 2){
                document.querySelector('#view-priority-ticket').innerHTML = '<span style="color:#4da1ff;border: 1px solid #4da1ff;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">MEDIA</span>';
                document.querySelector('#view-star').innerHTML = '<i class="fas fa-star"></i><i class="fas fa-star"></i>';
              }else if(objData.data.ticket.priority == 3){
                document.querySelector('#view-priority-ticket').innerHTML = '<span style="color:#F59C1A;border: 1px solid #F59C1A;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">ALTA</span>';
                document.querySelector('#view-star').innerHTML = '<i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>';
              }else if(objData.data.ticket.priority == 4){
                document.querySelector('#view-priority-ticket').innerHTML = '<span style="color:#ff5959;border: 1px solid #ff5959;padding: 2px 5px;border-radius: 5px;text-transform: uppercase;font-size: 9.5px;font-weight: 700;">URGENTE</span>';
                document.querySelector('#view-star').innerHTML = '<i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>';
              }
              ...
              document.querySelector('#view-description').innerHTML = objData.data.ticket.description;
              document.querySelector('#view-incident').innerHTML = objData.data.ticket.incident;
              if(objData.data.ticket.user_image == "user_default.png"){
                user_image = base_url+"/Assets/images/default/user_default.png";
              }else{
                user_image = base_url+"/Assets/uploads/users/"+objData.data.ticket.user_image;
              }
              document.querySelector('#view-user-post').src = user_image;
              document.querySelector('#view-user').innerHTML = "<b>"+objData.data.ticket.user+"</b>";
              var data_detail = '';
               if(objData.data.detail.length === 0){
                 data_detail += `
                   ...
                   <li class="comment">
                     ...
                     <div class="comment-body">
                       <div class="comment-heading">
                         ...
                         <h5 class="time"><b>INICIO:</b> ${moment(detail.opening_date).format('DD/MM/YYYY H:mm')}</h5> | <h5 class="time"><b>FIN:</b> ${moment(detail.closing_date).format('DD/MM/YYYY H:mm')}</h5>
                       </div>
                       <p>${detail.comment}</p>
                     </div>
                   </li>`;
...
function options_print(idticket){
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            var objData = JSON.parse(request.responseText);
            if(objData.status == "success"){
                document.querySelector('#text-title-message').innerHTML = "Ticket Nº "+objData.data.code;
                document.querySelector('#message_text_country').innerHTML = "+"+objData.data.country_code;
                document.querySelector('#message_country_code').value = objData.data.country_code;
                document.querySelector('#message_number_client').value = objData.data.mobile;
...
$('#btn-msg-message').on('click',function(){
    let cell = document.querySelector('#message_number_client').value;
    if(cell !== ""){
        let country = document.querySelector('#message_country_code').value;
        let message = document.querySelector('#message_msg').value;
        let url = "https://api.whatsapp.com/send/?phone="+country+cell+"&text="+message;
        window.open(url);
    }else{
      alert_msg("info","El número es obligatorio.")
...
function list_internet(){
    if(document.querySelector('#listInternet')){
        ...
        request.onreadystatechange = function(){
            if(request.readyState == 4 && request.status == 200){
                document.querySelector('#listInternet').innerHTML = request.responseText;
...
function list_personalized(){
    if(document.querySelector('#listPersonalized')){
        ...
        request.onreadystatechange = function(){
            if(request.readyState == 4 && request.status == 200){
                document.querySelector('#listPersonalized').innerHTML = request.responseText;
...
function add_internet(){
    if(list_int.value === ""){
      ...
      document.querySelector('#text-internet').innerHTML = "Añadir Servicio de Internet";
      document.querySelector('#text-button-internet').innerHTML ="Guardar Registro";
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status){
                ...
                document.querySelector("#details_internet").value = objData.data.details;
            }else{
                alert_msg("info",objData.msg);
            }
        }
...
function add_personalized(){
    if(list_perz.value === ""){
      ...
      document.querySelector('#text-personalized').innerHTML = "Añadir Servicio Personalizado";
      document.querySelector('#text-button-personalized').innerHTML ="Guardar Registro";
...
function select_personalized(idservices){
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            var objData = JSON.parse(request.responseText);
            if(objData.status == "success"){
                document.querySelector("#price_personalized").value = objData.data.price;
                document.querySelector("#details_personalized").value = objData.data.details;
            }else{
                alert_msg("info",objData.msg);
            }
        }
        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status == "success"){
                if(objData.data.type == 1){
                    document.querySelector('#text-internet').innerHTML = "Actualizar Servicio";
                    document.querySelector('#text-button-internet').innerHTML ="Guardar Cambios";
                    document.querySelector("#idinternet").value = objData.data.encrypt_id;
                    document.querySelector("#idconin").value = objData.data.encrypt_contract;
                    document.querySelector("#listInternet").value = objData.data.encrypt_service;
                ...
                if(objData.data.type == 2){
                    document.querySelector('#text-personalized').innerHTML = "Actualizar Servicio";
                    document.querySelector('#text-button-personalized').innerHTML ="Guardar Cambios";
                    document.querySelector("#idpersonalized").value = objData.data.encrypt_id;
                    document.querySelector("#idconper").value = objData.data.encrypt_contract;
                    document.querySelector("#listPersonalized").value = objData.data.encrypt_service;
