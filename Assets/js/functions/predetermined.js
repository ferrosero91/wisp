...
var noreceived_amount = 0,noreceived_total = 0;
document.addEventListener('DOMContentLoaded', function(){
  ...
  table = $('#'+table_name).DataTable({
    ...
    initComplete: function(oSettings, json){
      $("#"+table_name+"_wrapper div.container-options").html('<div class="options-group btn-group m-r-5"><button type="button" class="btn btn-white"><span class="badge label-warning f-s-10 f-w-700 mr-1">'+noreceived_amount+'</span><span>'+currency_symbol+roundNumber(noreceived_total,2)+'</span></button></div>');
   }
  });
},false);
