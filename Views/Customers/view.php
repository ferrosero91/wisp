      ...
      <div class="panel-body tab-content">
            ...
            <div class="row row-space-30">
              <div class="col-xl-7" style="border-right: 1px solid #e2e7ec !important;">
                ...
                <div class="form-group row m-b-10">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      <input type="text" class="form-control" name="document" id="document" onkeypress="return document_number(event)" placeholder="Número de documento" maxlength="12" value="<?= $client['document'] ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control text-uppercase" name="names" id="names" onkeypress="return letters(event)" placeholder="INGRESE NOMBRE" value="<?= $client['names'] ?>" data-parsley-group="step-1" data-parsley-required="true">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-md-3 text-lg-right col-form-label">Apellidos</label>
                  <div class="col-md-9">
                    <input type="text" class="form-control text-uppercase" name="surnames" id="surnames" onkeypress="return letters(event)" placeholder="INGRESE APELLIDOS" value="<?= $client['surnames'] ?>" data-parsley-group="step-1" data-parsley-required="true">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-md-3 text-lg-right col-form-label">Celulares</label>
                  <div class="col-md-9">
                    <input type="text" class="form-control m-b-10" name="mobile" id="mobile" onkeypress="return numbers(event)" placeholder="3001234567" maxlength="10" value="<?= $client['mobile'] ?>" data-parsley-group="step-1" data-parsley-required="true">
                    <input type="text" class="form-control" name="mobileOp" id="mobileOp" onkeypress="return numbers(event)" placeholder="3001234567" maxlength="10" value="<?= $client['mobile_optional'] ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" name="email" id="email" onkeypress="return mail(event)" placeholder="EXAMPLE@EXAMPLE.com" value="<?= $client['email'] ?>">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control text-uppercase" name="address" id="address" onkeypress="return numbersandletters(event)" placeholder="INGRESE DOMICILIO" value="<?= $client['address'] ?>" data-parsley-group="step-1" data-parsley-required="true">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-md-3 text-lg-right col-form-label">Referencia</label>
                  <div class="col-md-9">
                    <input type="text" class="form-control text-uppercase" name="reference" id="reference" onkeypress="return numbersandletters(event)" placeholder="REFERENCIA DEL DOMICILIO (OPCIONAL)" value="<?= $client['reference'] ?>">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <div class="widget-list widget-list-rounded m-b-5" data-id="widget">
                      <div class="widget-list-item bg-indigo">
                        <div class="widget-list-media icon p-5"><i class="fa fa-envelope f-s-30 f-w-700 text-white"></i></div>
                        <div class="widget-list-content p-5">
        ...
        <div class="tab-pane fade" id="gallery-tab">
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-12"><hr class="m-t-0 m-b-10"></div>
            <div class="col-md-12 col-sm-12 col-12">
