                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" class="form-control" name="mobile" id="mobile" onkeypress="return numbers(event)" maxlength="10" placeholder="3001234567" data-parsley-required="true">
                        </div>
