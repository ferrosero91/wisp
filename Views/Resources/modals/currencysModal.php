                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control text-uppercase" name="symbol" id="symbol" placeholder="S/." onkeypress="return numbersandletters(event)" maxlength="3" data-parsley-required="true">
                        </div>
                        <div class="col-md-12 form-group">
