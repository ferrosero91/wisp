        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-3 form-group">
              ...
              <input type="text" class="form-control" name="price" id="price_internet" onkeypress="return numbers(event)" placeholder="0.00" data-parsley-required="true" readonly>
            </div>
            <div class="col-md-6 form-group hide-descent">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="descent" id="descent" onkeypress="return numbers(event)" placeholder="0" readonly>
              </div>
            </div>
            <div class="col-md-6 form-group hide-rise">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="rise" id="rise" onkeypress="return numbers(event)" placeholder="0" readonly>
              </div>
            </div>
            <div class="col-md-12 form-group">
              <label for="details_internet" class="control-label">Detalles</label>
              <input type="text" class="form-control" id="details_internet" name="details" onkeypress="return numbersandletters(event)" placeholder="INTERNET BANDA ANCHA 4Mbps/2Mbps" readonly>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-white" data-dismiss="modal"></i>Cerrar</button>
          <button type="submit" class="btn btn-blue"><i class="fas fa-save mr-2"></i><span id="text-button-internet"></span></button>
        </div>
      </div>
    </div>
  </form>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-3 form-group">
              ...
              <input type="text" class="form-control" name="price" id="price_personalized" onkeypress="return numbers(event)" placeholder="0.00" data-parsley-required="true" readonly>
            </div>
            <div class="col-md-12 form-group">
              <label for="details_personalized" class="control-label">Detalles</label>
              <input type="text" class="form-control" id="details_personalized" name="details" onkeypress="return numbersandletters(event)" placeholder="INTERNET BANDA ANCHA 4Mbps/2Mbps" readonly>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-white" data-dismiss="modal"></i>Cerrar</button>
          <button type="submit" class="btn btn-blue"><i class="fas fa-save mr-2"></i><span id="text-button-personalized"></span></button>
        </div>
      </div>
    </div>
  </form>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body row">
          ...
          <div class="col-md-6 form-group">
            ...
            <input type="text" class="form-control text-uppercase" name="observation" id="obfree" placeholder="INGRESE OBSERVACIÓN">
          </div>
                ...
                <table class="table table-bordered table-invoice" id="table-free">
                  <thead>
                    <tr>
                      ...
                      <th style="border-color:#2d353c" class="text-uppercase f-s-12 text-left" width="60%">Descripción</th>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td colspan="2"><input type="text" class="form-control" value="0.00" id="discountfree" name="discount"></td>
                    </tr>
                  </tfoot>
                </table>
                <div class="pull-left" style="margin-bottom:10px;">
                  <button type="button" onclick="addItem('libre')" class="btn btn-default"><i class="fas fa-plus"></i> Agregar Línea</button>
                </div>
              </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-white" data-dismiss="modal"></i>Cerrar</button>
          <button type="submit" class="btn btn-blue"><i class="fas fa-save mr-2"></i><span id="text-button-free"></span></button>
        </div>
      </div>
    </div>
  </form>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body row">
          ...
          <div class="col-md-8 form-group mb-3">
            <label class="control-label">Observación</label>
            <input type="text" class="form-control text-uppercase" name="observation" id="observ" placeholder="INGRESE OBSERVACIÓN">
          </div>
          <div class="invoice">
            <div class="invoice-content">
              <div class="table-responsive">
                <table id="table-plans" class="table table-bordered table-invoice">
                  <thead>
                    <tr>
                      <th style="border-color:#2d353c" class="table-header text-uppercase f-s-12 text-left" width="60%">Descripción</th>
                      <th style="border-color:#2d353c" class="table-header text-uppercase f-s-12" width="80px">Precio</th>
                      <th style="border-color:#2d353c" class="table-header text-uppercase f-s-12" width="80px">Cantidad</th>
                      <th style="border-color:#2d353c" class="table-header text-uppercase f-s-12" width="60px">Total</th>
                      <th style="border-color:#2d353c" class="text-uppercase f-s-12" width="40px"></th>
                    </tr>
                  </thead>
                  <tbody></tbody>
                  <tfoot>
                    <tr>
                      ...
                      <td colspan="2"><input type="text" class="form-control" id="discountserv" name="discount" value="0.00"></td>
                    </tr>
                  </tfoot>
                </table>
                <div class="pull-left" style="margin-bottom:10px;">
                  <button type="button" onclick="addItem('service')" class="btn btn-default"><i class="fas fa-plus"></i> Agregar Línea</button>
                </div>
              </div>
              <div class="invoice-price">
                <div class="invoice-price-left">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-white" data-dismiss="modal"></i>Cerrar</button>
          <button type="submit" class="btn btn-blue"><i class="fas fa-save mr-2"></i><span id="text-button-facser"></span></button>
        </div>
      </div>
    </div>
  </form>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-12 form-group">
              ...
              <textarea class="form-control text-uppercase" name="comment" id="comment" placeholder="INGRESE COMENTARIO" rows="6" style="min-height: 20px; overflow: hidden; overflow-wrap: break-word; height: 80px;"></textarea>
            </div>
          </div>
        </div>
        <div class="modal-footer">
...
<div id="modal-map" class="modal fade p-0" role="dialog" style="display: none;">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title text-uppercase" id="text-map"></h6>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body no-padding">
        <div id="locations" style="width: 100%; height: 600px; position: relative; overflow: hidden;"></div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12 form-group">
              <p class="m-0">Antes de iniciar la importación generar una copia de seguridad en caso revertir algún cambio no deseado, en caso de incluir clientes repetidos estos seran excluidos de la importación.
              <a href="<?= base_style() ?>/resources/clients.xlsx">Descargar Plantilla</a></p>
            </div>
            <div class="col-md-12 form-group">
              <div class="input-group">
                ...
                <div class="input-group-append">
                  <label class="btn btn-default cursor-pointer" for="import_clients">
                    <input type="file" id="import_clients" name="import_clients" accept=".xls, .xlsx" style="display:none">
            ...
            <div class="col-md-12">
              <p class="m-0"><strong>Nota:</strong> Tener en cuenta que el servicio y el técnico deben estar registrado previamente.</p>
            </div>
          </div>
        </div>
        <div class="modal-footer">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col text-center font-weight-bold mt-3">
            <button type="button" class="btn btn-lg btn-dark" id="btn-ticket"><i class="fa fa-receipt fa-5x"></i></button>
            <p>PDF TICKET</p>
          </div>
          <div class="col text-center font-weight-bold mt-3">
            <button type="button" class="btn btn-lg btn-dark" id="btn-print_ticket"><i class="ion ion-ios-print fa-5x"></i></button>
            <p>IMPRIMIR</p>
          </div>
        </div>
        <div class="row mt-3">
          <div class="col-md-12">
            <div class="input-group m-b-10">
              ...
              <input type="text" id="bill_number_client" class="form-control" onkeypress="return numbers(event)" placeholder="999999999" maxlength="25">
              <div class="input-group-append">
                <button type="button" class="btn btn-whatsapp" id="btn-msg"><i class="fab fa-whatsapp fa-lg mr-1"></i>Enviar</button>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col text-center font-weight-bold mt-3">
            <button type="button" class="btn btn-lg btn-primary" id="btn-sms"><i class="fas fa-comment-alt fa-5x"></i></button>
            <p>SMS</p>
          </div>
          <div class="col text-center font-weight-bold mt-3">
            <button type="button" class="btn btn-lg btn-info" id="btn-tocall"><i class="fa fa-phone-alt fa-5x"></i></button>
            <p>Llamar</p>
          </div>
          <div class="col text-center font-weight-bold mt-3">
            <button type="button" class="btn btn-lg btn-whatsapp" id="btn-whatsapp"><i class="fab fa-whatsapp fa-5x"></i></button>
            <p>WhatsApp</p>
          </div>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col text-center font-weight-bold mt-3">
            <button type="button" class="btn btn-lg btn-dark" id="btn-ticket-message"><i class="fa fa-receipt fa-5x"></i></button>
            <p>TICKET SOPORTE</p>
          </div>
        </div>
        <div class="row mt-3">
          <div class="col-md-12">
            <div class="input-group m-b-10">
              ...
              <input type="text" id="message_number_client" class="form-control" onkeypress="return numbers(event)" placeholder="999999999" maxlength="25">
              <div class="input-group-append">
                <button type="button" class="btn btn-whatsapp" id="btn-msg-message"><i class="fab fa-whatsapp fa-lg mr-1"></i>Enviar</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-12 form-group">
              ...
              <textarea class="form-control text-uppercase" name="observation" id="obserfinalize" rows="6" style="min-height: 50px; overflow: hidden; overflow-wrap: break-word; height: 80px;" data-parsley-required="true" placeholder="Ingrese su descripcion"></textarea>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-white" data-dismiss="modal"></i>Cerrar</button>
          <button type="submit" class="btn btn-blue"><i class="fas fa-save mr-2"></i><span id="text-button-finalize"></span></button>
        </div>
      </div>
    </div>
  </form>
