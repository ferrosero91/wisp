                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <a href="<?= base_style() ?>/resources/bills.xlsx">Descargar Plantilla</a></p>
                        </div>
                        <div class="col-md-12 form-group">
                          <div class="input-group">
                              ...
                              <div class="input-group-append">
                                <label class="btn btn-default cursor-pointer" for="import_bills">
                                  <input type="file" id="import_bills" name="import_bills" accept=".xls, .xlsx" style="display:none">
                        ...
                        <div class="col-md-12">
                            <p class="m-0"><strong>Nota:</strong> Tener en cuenta que el cliente debe estar registrado previamente, en caso no estarlo la factura no sera tomada en cuenta.</p>
                  ...
                  <div class="col-md-12 col-sm-12 col-12" data-sortable="false">
                      <div class="panel panel-default panel-months mb-0" data-sortable="false">
                          <div class="panel-heading">
                              <h4 class="panel-title">Emitir <strong class="f-s-14" id="total_collection">0</strong> facturas de <strong class="f-s-14" id="total_clients">0</strong> clientes</h4>
                          ...
                          <div class="panel-body border-panel">
                              <div class="row">
                                <div class="col-md-12 col-sm-12 col-12">
                                    <div class="table-responsive">
                                        <table id="list-client" class="table table-bordered dt-responsive nowrap dataTable dtr-inline collapsed" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>Nº</th>
                                                    <th>Cliente</th>
                        ...
                        <div class="invoice-content">
                            <div class="table-responsive">
                                <table class="table table-bordered table-invoice" id="table-free">
                                    <thead>
                                        <tr>
                                            <th style="border-color:#2d353c" class="text-uppercase f-s-12" width="0px"></th>
                        ...
                        <div class="invoice-content">
                            <div class="table-responsive">
                                <table id="table-plans" class="table table-bordered table-invoice">
                                    <thead>
                                        <tr>
                                            <th style="border-color:#2d353c" class="table-header text-uppercase f-s-12 text-left">Descripción</th>
                                            ...
                                            <th style="border-color:#2d353c" class="table-header text-uppercase f-s-12" width="80px">Total</th>
                                            <th style="border-color:#2d353c" class="text-uppercase f-s-12" width="40px"></th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
