				...
				<tbody>
					<tr style="padding: 0px;">
						...
						<p style="font-size: 9px; text-align: center;">
							...
							<?php else: ?>
									<img src="<?= base_style().'/images/logotypes/logo.png' ?>" style="width: 200px; height: 90px;">
							<?php endif; ?>
						</p>
						<p style="font-size: 9px; text-align: center;">
						...
						<p style="font-size: 9px; text-align: center;">
							<span style="font-family:arial,helvetica,sans-serif;">
								<span style="font-size:13px;"><strong>NIT: </strong><strong><?= $_SESSION['businessData']['ruc'] ?></strong> </span>
							</span>
						</p>
						<p style="font-size: 9px; text-align: center;">
							<span style="font-family:arial,helvetica,sans-serif;">
