					...
					<tr style="padding: 0px;">
						...
						<p style="font-size: 9px; text-align: center;">
							<?php if (file_exists($logo)): ?>
									<img src="<?= base_url()."/".$logo ?>" style="width: 200px; height: 90px;">
							<?php else: ?>
									<img src="<?= base_style().'/images/logotypes/logo.png' ?>" style="width: 170px; height: 50px;">
							<?php endif; ?>
						</p>
						<p style="font-size: 9px; text-align: center;">
						...
						<p style="font-size: 9px; text-align: center;">
							<span style="font-family:arial,helvetica,sans-serif;">
								<span style="font-size:13px;"><strong>NIT: </strong><strong><?= $business['ruc'] ?></strong> </span>
							</span>
						</p>
						<p style="font-size: 9px; text-align: center;">
							<span style="font-family:arial,helvetica,sans-serif;">
						...
						<td style="padding: 0px; width: 100%;">
							...
							<?php if($bill['voucherid'] == 2 || $bill['voucherid'] == 3): ?>
								...
								<div class="contenedor-qr">
									<img src="<?= generate_qr_image($name_qr,$route_qr,5,"H",3); ?>" width="135px">
								</div>
							<?php endif; ?>
