...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Adjuntamos su factura electrónica autorizada por la DIAN.</p>
            
            <div class="info-box">
                <strong>Documento:</strong> <?= $ei['prefix'] ?? '' ?> - <?= str_pad($ei['number'] ?? 0, 7, "0", STR_PAD_LEFT) ?><br>
                <strong>CUFE:</strong> <small><?= $ei['cufe'] ?? 'N/A' ?></small><br>
            ...
            <p>Para verificar la autenticidad de este documento, puede escanear el código QR incluido en la factura o consultar en el portal de la DIAN.</p>
        </div>
        <div class="footer">
