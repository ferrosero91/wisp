                  ...
                  <div class="row row-space-30">
                      <div class="col-xl-9">
                          ...
                          <div class="form-group row m-b-10">
                              <label class="col-md-3 text-lg-right col-form-label">N° Documento</label>
                              <div class="col-md-4">
              ...
              <fieldset>
                <div class="row">
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    <textarea class="form-control text-uppercase" name="observation" id="observation" rows="6" style="min-height: 50px; overflow: hidden; overflow-wrap: break-word; height: 80px;" data-parsley-group="step-3" data-parsley-required="true" placeholder="Ingrese observación"></textarea>
                  </div>
                  <div class="col-md-12 col-md-push-5 col-sm-12 p-sm">
                    <fieldset>
