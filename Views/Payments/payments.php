    ...
    <div class="panel-body border-panel">
        <div class="row">
            ...
            <div id="list-btns-exportable" style="display: none;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-white" id="btn-select-all-list_wrapper" data-toggle="tooltip" data-original-title="Seleccionar todo">
                  <i class="far fa-check-square f-s-14"></i>
                  <span class="badge label-warning f-s-10 list_amount_selected">0</span>
                </button>
              </div>
              <div class="btn-group">
                <button type="button" class="btn btn-white" id="btn-unselect-all-list_wrapper" data-toggle="tooltip" data-original-title="Limpiar selección">
                  <i class="far fa-square f-s-14"></i>
                </button>
              </div>
              <div class="btn-group">
                <button type="button" class="btn btn-white" onclick="cancel_massive()" data-toggle="tooltip" data-original-title="Cancelar pagos">
            ...
            <div id="list-btns-tools" style="display: none;">
              ...
              <?php if($_SESSION['userData']['profileid'] == ADMINISTRATOR){ ?>
                <button type="button" class="btn btn-white" onclick="export_pdf()"><i class="far fa-file-pdf f-s-14 mr-1"></i>Exportar pdf</button>
                <button type="button" class="btn btn-white" onclick="export_excel()"><i class="far fa-file-excel f-s-14 mr-1"></i>Exportar excel</button>
              <?php } ?>
